...
const KaraokeWord = ({ word, idx, active }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    "span",
    {
      style: {
        ...
        textShadow: isActive ? "0 0 28px rgba(255,214,10,.9), 0 0 8px rgba(255,214,10,.5), 0 2px 10px rgba(0,0,0,.6)" : "0 2px 10px rgba(0,0,0,.5)",
...
const WordPopWord = ({ word, idx, active, wordDuration }) => {
  ...
  const opacity = (0,esm.interpolate)(localFrame, [0, 5], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const translateY = (0,esm.interpolate)(progress, [0, 1], [30, 0]);
  const scale = (0,esm.interpolate)(progress, [0, 1], [0.35, 1]);
  return /* @__PURE__ */ react.createElement(
    "span",
    {
      style: {
        ...
        color: isActive ? "#FFD60A" : "#ffffff",
        textShadow: isActive ? "0 0 20px rgba(255,214,10,.7)" : "0 2px 10px rgba(0,0,0,.5)",
...
const NeonWord = ({ word, idx, active }) => {
  const isActive = idx === active;
  const isPast = idx < active;
  const isFuture = idx > active;
  return /* @__PURE__ */ react.createElement(
    "span",
    {
      style: {
        ...
        textShadow: isActive ? "0 0 6px #fff, 0 0 18px #818cf8, 0 0 38px #6366f1, 0 0 70px #4f46e5" : isPast ? "0 0 12px rgba(165,180,252,.5)" : "none",
...
const SubtitleChunk = ({ words, style, totalDuration }) => {
  const frame = (0,esm.useCurrentFrame)();
  const N = words.length;
  const wordDuration = Math.max(1, Math.floor(totalDuration / N));
  const activeIdx = Math.min(Math.floor(frame / wordDuration), N - 1);
  const fadeIn = (0,esm.interpolate)(frame, [0, 5], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const fadeOut = (0,esm.interpolate)(frame, [totalDuration - 7, totalDuration], [1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const bgStyle = style === "neon" ? {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      words.map((word, i) => {
        if (style === "karaoke") {
          return /* @__PURE__ */ react.createElement(KaraokeWord, { key: i, word, idx: i, active: activeIdx });
        } else if (style === "word-pop") {
          return /* @__PURE__ */ react.createElement(WordPopWord, { key: i, word, idx: i, active: activeIdx, wordDuration });
        } else {
          return /* @__PURE__ */ react.createElement(NeonWord, { key: i, word, idx: i, active: activeIdx });
        }
      })
    )
  );
...
const SUBTITLES = [
  ...
  },
  {
    ...
    durationInFrames: 42,
    // 1.40s
    text: "cada proyecto inmobiliario"
  },
  {
    id: 3,
    from: 89,
  ...
  },
  {
    ...
    durationInFrames: 51,
    // 1.70s
    text: "error de compatibilizaci\xF3n"
  },
  {
    id: 14,
    from: 685,
...
const { fontFamily: Composition_fontFamily } = loadFont("normal", {
  weights: ["700"],
  subsets: ["latin"]
});
...
const MyComposition = () => {
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: "#000000" } }, /* @__PURE__ */ react.createElement(
    esm.Video,
    {
      src: (0,esm.staticFile)("video.mp4"),
    ...
    {
      style: {
        fontFamily: Composition_fontFamily,
        fontSize: 67,
        fontWeight: 700,
        color: "#ffffff",
        letterSpacing: "-0.2px",
...
const VIDEO_DURATION_FRAMES = 1079;
const VIDEO_FPS = 30;
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(559), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 9559)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "my-remotion-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmy_remotion_video"] = self["webpackChunkmy_remotion_video"] || [];
